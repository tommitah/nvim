...
local get_gps = function()
	...
	if not require("plugins.functions").isempty(gps_location) then
		return require("plugins.icons").ui.ChevronRight .. " " .. gps_location
	else
		return ""
	end
end
...
M.get_winbar = function()
	...
	if not f.isempty(value) and f.get_buf_option("mod") then
		local mod = "%#LspCodeLens#" .. require("plugins.icons").ui.Circle .. "%*"
		if gps_added then
			value = value .. " " .. mod
		else
			value = value .. mod
