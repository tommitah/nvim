...
vim.cmd [[ command! LspToggleAutoFormat execute 'lua require('plugins.functions').toggle_format_on_save()' ]]

vim.cmd [[ command! SnipRunToggle execute 'lua require("plugins.functions").toggle_sniprun()' ]]
